...
namespace SG
{
    ...
    {
        [SerializeField] AIBossCharacterManager undeadCharacterCausingDamage;//当计算伤害时用来检查攻击来源的伤害修正
        ...
        protected override void Awake()
        {
            ...
            undeadCharacterCausingDamage = GetComponentInParent<AIBossCharacterManager>(); //在这个伤害碰撞器的父对象中找到一个带有AICharacterManager组件的对象，并将其赋值给undeadCharacterCausingDamage变量，这样伤害碰撞器就可以使用这个变量来获取攻击来源的角色信息和伤害修正等数据
